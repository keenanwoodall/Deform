...
namespace DeformEditor
{
	public class DeformEditorSettingsAsset : ScriptableObject
	{
		...
		[DisplayName("Light Color")] public Color lightHandleColor = new Color (1f, 0.4f, 0f, 0.5f);
		[DisplayName("Light Color")] public Color recordingHandleColor = new Color (1f, 0f, 0f, 0.9f);
